...
export const fileList = [
  ...
  { filePath: 'SWGEmu_Setup.exe', fileHash: '' },
  { filePath: 'swgemu_preload.cfg', fileHash: '' },
  { filePath: 'swgemu_live.cfg', fileHash: '' },
  { filePath: 'SWGEmu.exe', fileHash: '' },
  { filePath: 'swgemu.cfg', fileHash: '' },
  { filePath: 's207_r.dll', fileHash: '' },
  { filePath: 's206_r.dll', fileHash: '' },
  { filePath: 's205_r.dll', fileHash: '' },
  { filePath: 'qt-mt305.dll', fileHash: '' },
  { filePath: 'Mss32.dll', fileHash: '' },
  { filePath: 'em07_u.dll', fileHash: '' },
  { filePath: 'em06_u.dll', fileHash: '' },
  { filePath: 'em05_u.dll', fileHash: '' },
  { filePath: 'dpvs.dll', fileHash: '' },
  { filePath: 'dbghelp.dll', fileHash: '' },
  { filePath: 'texture/loading/space/images/space_load_pvp.dds', fileHash: '' },
  { filePath: 'string/en/live_motd.stf', fileHash: '' },
  { filePath: 'string/en/test_motd.stf', fileHash: '' },
  { filePath: 'string/en/ui_auc.stf', fileHash: '' },
  { filePath: 'miles/mssdsp.flt', fileHash: '' },
  { filePath: 'miles/Msseax.m3d', fileHash: '' },
  { filePath: 'miles/mssmp3.asi', fileHash: '' },
  { filePath: 'miles/msssoft.m3d', fileHash: '' }
].reverse()
